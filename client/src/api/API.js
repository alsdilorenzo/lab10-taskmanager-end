...
async function getTasks(filter) {
    ...
    if (response.ok) {
        ...
        //return tasksJson.map((t) => new Task(t.id,t.description,t.important, t.privateTask, t.project, t.deadline, t.completed, t.user));
    } else {
        throw {status: response.status, errObj: tasksJson};  // An object with the error coming from the server
    }
}
